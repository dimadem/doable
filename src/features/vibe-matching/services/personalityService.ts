...
export const saveUserSession = async (
  ...
  try {
    ...
    // Verify the personality exists before saving
    const personalityExists = personalities.some(p => p.name === dominantPersonality);
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        // Let session_id be generated by the database default
        // Let user_id be handled by RLS if authenticated
      })
      .select()
      .single();
